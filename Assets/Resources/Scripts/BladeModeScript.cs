...
public class BladeModeScript : MonoBehaviour
{
    ...
    void Start()
    {
        //correct cursor elements

        Cursor.lockState = CursorLockMode.Locked;
        Cursor.visible = false;
        cutPlane.gameObject.SetActive(false);

        //direct cinemachine camera to the correct position
        ...
        //loop through components and find the correct one
        for (int i = 0; i < 3; i++)
    ...
    void Update()
    {
        //set the x float to the correct value
        ...
        //make sure blade mode is active and affecting tge canera
    ...
    public void Slice()
    {
        //make sure the slice is affecting the object in the correct spot
        ...
        {
            //define the slice crossmaterial and make sure the object is affected appropriately
